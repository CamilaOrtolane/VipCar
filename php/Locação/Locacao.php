...
class Locacao {
    ...
    public function criar() {
        $query = "INSERT INTO " . $this->table . " 
                  (data_entrada, data_saida, horario_entrada, horario_saida, valor_por_dia, valor_total, 
                   local_retirada_cidade, local_entrega, status, id_cliente_fk, id_veiculo_fk, id_local_locadora_fk) 
                  VALUES 
                  (:data_entrada, :data_saida, :horario_entrada, :horario_saida, :valor_por_dia, :valor_total, 
                   :local_retirada_cidade, :local_entrega, :status, :id_cliente_fk, :id_veiculo_fk, :id_local_locadora_fk)";
        ...
        $stmt->bindParam(':id_local_locadora_fk', $this->id_local_locadora_fk);
    ...
    public function editar() {
        $query = "UPDATE " . $this->table . " SET 
                  ...
                  id_local_locadora_fk = :id_local_locadora_fk
                  WHERE id = :id";
